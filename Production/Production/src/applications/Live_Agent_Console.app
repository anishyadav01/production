...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <domainWhitelist>
        <domain>knowledge.dom01.local</domain>
    </domainWhitelist>
    ...
    <label>Live Agent Console</label>
    <listPlacement>
    ...
    <liveAgentConfig>
        ...
        <pagesToOpen>
            <pageToOpen>LiveAgentCreateCase</pageToOpen>
        </pagesToOpen>
        <showKnowledgeArticles>false</showKnowledgeArticles>
    </liveAgentConfig>
    <logo>Logos/TalkTalk_Logo.jpg</logo>
    <saveUserSessions>false</saveUserSessions>
    <tab>standard-Case</tab>
    <tab>standard-Contact</tab>
    <tab>Knowledge</tab>
    <tab>Work_Requests__c</tab>
    <tab>Project__c</tab>
    <tab>Release__c</tab>
    <tab>Licenses__c</tab>
    <workspaceMappings>
